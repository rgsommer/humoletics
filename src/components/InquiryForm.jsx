...
export default function InquiryForm({
  ...
  // Holds the composed enquiry whenever we cannot POST it, so a submission is
  // visible and recoverable rather than silently lost to a mailto that no-ops.
  ...
  const onSubmit = async (e) => {
    ...
    // No endpoint configured. Try the sender's mail client, but never rely on it:
    // mailto silently does nothing on machines with no mail handler.
